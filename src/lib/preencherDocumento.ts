 ...
 * defaults plausíveis — todos sujeitos a revisão. Os dados da empresa chegam por
 * parâmetro (vindos de useDadosEmpresa) para manter a função pura — sem hook.
 */
export function montarPlaceholders(
  ...
  return {
    // Empresa
    empresa_factoring_razao_social: empresa.razaoSocial,
    empresa_factoring_cnpj: empresa.cnpj,
    empresa_factoring_endereco: empresa.endereco,
    ...
    // Assinatura
    cidade_assinatura: cedente?.cidade ?? empresa.cidade,
